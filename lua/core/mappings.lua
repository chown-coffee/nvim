...
-- personal scripts
vim.cmd [[ autocmd filetype c,cpp nmap <A-h> :!$HOME/.scripts/c/header-create.sh -e false -n ]]

vim.cmd [[ autocmd filetype c,cpp nmap <A-i> :!$HOME/.scripts/c/header-impl.sh -e false -n ]]

vim.cmd [[ autocmd filetype c,cpp nmap <A-a> :!$HOME/.scripts/c/include.sh -n ]]

-- bufferline
vim.api.nvim_set_keymap('n', '<leader>bc', ':BufferLinePickClose<CR>', {})

-- fuzzy search
vim.api.nvim_set_keymap('n', '<A-z>', ':CtrlP<CR>', { noremap=true })
vim.api.nvim_set_keymap('n', '<leader>PF', ':Files<CR>', {})
vim.api.nvim_set_keymap('n', '<leader>PR', ':Rg<CR>', {})
vim.api.nvim_set_keymap('n', '<leader>PL', ':BLines<CR>', {})
vim.api.nvim_set_keymap('n', '<leader>PB', ':Lines<CR>', {})
...
vim.api.nvim_set_keymap('n', '<leader>HT', ':HexokinaseToggle<CR>', {})
